...
export default function ProductDetails({ product, products }) {
    ...
    const {qty, increaseQty, decreaseQty, onAdd, setShowCart } = StateContext
            ...
            <div className="product-detail-container">
                ...
                <div className="product-detail-desc">
                        ...
                        <div className="buttons">
                            <button type="button" className="add-to-cart" onClick={e => onAdd(product, qty)}>Add to Cart</button>
